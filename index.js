...
app.get('/jokes/:id', (req, res) => {
  var jokeID = jokes.findIndex(joke => joke.id == req.params.id);
...
app.put('/jokes/:id', (req, res) => {
  if(req.body.text && req.body.type && req.params.id > 0 && req.params.id <= jokes.length) {
    var searchIndex = jokes.findIndex(joke => joke.id == req.params.id);
    jokes[searchIndex].jokeText = req.body.text;
    jokes[searchIndex].jokeType = req.body.type;
    res.json(jokes[searchIndex]);
  } else {
    res.json({ error: "You need to give all the information for this joke."});
  }
});
...
app.patch('/jokes/:id', (req, res) => {
  ...
  var currJoke = jokes.find(joke => joke.id == id);
  var updatedJoke = {
    id: id,
...
app.delete('/jokes/:id', (req, res) => {
  ...
  if (searchIndex > -1) {
    ...
    res.status(404).json({error: `Joke with id: ${req.params.id} not found. No jokes were deleted.`});
  }
});
...
app.delete('/all', (req, res) => {
  if (req.query.key === masterKey) {
    ...
    res.status(404).json({ error: "The API key you have sent is not valid." });
  }
